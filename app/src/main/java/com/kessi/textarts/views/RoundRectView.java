...
public class RoundRectView extends ShapeOfView {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        super.setClipPathCreator(new ClipPathManager.ClipPathCreator() {
            /* class com.kessi.textarts.views.RoundRectView.AnonymousClass1 */
            ...
            public Path createClipPath(int i, int i2) {
                ...
                float min = roundRectView.min(roundRectView.topLeftRadius, f, f2);
                RoundRectView roundRectView2 = RoundRectView.this;
                float min2 = roundRectView2.min(roundRectView2.topRightRadius, f, f2);
                RoundRectView roundRectView3 = RoundRectView.this;
                float min3 = roundRectView3.min(roundRectView3.bottomRightRadius, f, f2);
                RoundRectView roundRectView4 = RoundRectView.this;
                return roundRectView.generatePath(roundRectView.rectF, min, min2, min3, roundRectView4.min(roundRectView4.bottomLeftRadius, f, f2));
            }
        });
    }
