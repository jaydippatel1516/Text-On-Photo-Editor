...
public class WinterFragment extends BottomSheetDialogFragment {
    ...
    public class WinterAdapter extends RecyclerView.Adapter<WinterAdapter.ViewHolder> {
        ...
        public void onBindViewHolder(ViewHolder viewHolder, int i) {
            Glide.with((FragmentActivity) Objects.requireNonNull(WinterFragment.this.getActivity())).load(Integer.valueOf(this.winterList[i])).thumbnail(0.1f).into(viewHolder.imgSticker);
        }
