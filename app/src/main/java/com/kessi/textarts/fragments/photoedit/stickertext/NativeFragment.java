...
public class NativeFragment extends BottomSheetDialogFragment {
    ...
    public class NativaAdapter extends RecyclerView.Adapter<NativaAdapter.ViewHolder> {
        ...
        public void onBindViewHolder(ViewHolder viewHolder, int i) {
            Glide.with((FragmentActivity) Objects.requireNonNull(NativeFragment.this.getActivity())).load(Integer.valueOf(this.imgNatives[i])).thumbnail(0.1f).into(viewHolder.imageView);
        }
        ...
        public class ViewHolder extends RecyclerView.ViewHolder {
            ...
            ViewHolder(View view) {
                super(view);
                this.imageView = (ImageView) view.findViewById(R.id.imgSticker);
                view.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        if (NativeFragment.this.listener != null) {
                            NativeFragment.this.listener.onOverplayClick(BitmapFactory.decodeResource(NativeFragment.this.getResources(), NativaAdapter.this.imgNatives[getLayoutPosition()]));
                        }
                        NativeFragment.this.dismiss();
                    }
                });
