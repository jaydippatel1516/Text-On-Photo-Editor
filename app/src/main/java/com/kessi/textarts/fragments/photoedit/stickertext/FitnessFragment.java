...
public class FitnessFragment extends BottomSheetDialogFragment {
    ...
    public class FitnessAdapter extends RecyclerView.Adapter<FitnessAdapter.ViewHolder> {
        ...
        public void onBindViewHolder(ViewHolder viewHolder, int i) {
            Glide.with((FragmentActivity) Objects.requireNonNull(FitnessFragment.this.getActivity())).load(Integer.valueOf(this.fitnessList[i])).thumbnail(0.1f).into(viewHolder.imgSticker);
        }
                ...
                view.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (FitnessFragment.this.listener != null) {
                            FitnessFragment.this.listener.onOverplayClick(BitmapFactory.decodeResource(FitnessFragment.this.getResources(), FitnessAdapter.this.fitnessList[getLayoutPosition()]));
                        }
                        FitnessFragment.this.dismiss();
                    }
                });
