...
public class PhrasesFragment extends BottomSheetDialogFragment {
    ...
    public class PhrasesAdapter extends RecyclerView.Adapter<PhrasesAdapter.ViewHolder> {
        ...
        public void onBindViewHolder(ViewHolder viewHolder, int i) {
            Glide.with((FragmentActivity) Objects.requireNonNull(PhrasesFragment.this.getActivity())).load(Integer.valueOf(this.phrasesList[i])).thumbnail(0.1f).into(viewHolder.imgSticker);
        }
                ...
                view.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (PhrasesFragment.this.listener != null) {
                            PhrasesFragment.this.listener.onOverplayClick(BitmapFactory.decodeResource(PhrasesFragment.this.getResources(), PhrasesAdapter.this.phrasesList[getLayoutPosition()]));
                        }
                        PhrasesFragment.this.dismiss();
                    }
                });
